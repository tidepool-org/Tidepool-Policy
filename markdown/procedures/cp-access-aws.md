...
* Additional details are documented on the [Development Wiki](https://tidepool.atlassian.net).
...
* Engineering Lead has access to the Hardware Tokens associated with the root
  users.
    ...
    * The token serial is mapped per account and documented in [Tidepool
      Engineering Wiki](https://tidepool.atlassian.net).

When root access is required for business or operational needs, a https:&#x2F;&#x2F;tidepool.atlassian.net Issue is
