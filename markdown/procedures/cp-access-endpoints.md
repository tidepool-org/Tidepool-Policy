...
Most workstations at Tidepool are company owned, using one the following approved
hardware vendors and operating systems:

* Apple, Dell, or Lenovo
* macOS, Linux (Ubuntu or Debian), or Windows 10

BYOD is permitted with permission, but devices must be audited under the same guidance as company owned devices and may need to implement security profiles or agents to ensure compliance
