...
3. Whenever possible, audit logs shall be stored on a separate system to
    ...
    * Tidepool uses Sumo Logic to provide Logging as a Service
    * Tidepool logging servers may include Kibana and other monitoring stacks
      as part of their baseline configuration to ease reviewing of audit
