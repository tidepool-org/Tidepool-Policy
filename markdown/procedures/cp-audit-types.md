...
2. **Access Review:** This refers to the review of all user and service accounts
    ...
    * Tidepool leverages automated cloud tools to automatically pull configurations
      from our cloud based environments, including
        ...
        - Users, groups, application access from Google directory;
        - Network access settings from AWS and Google, etc.
