...
1. Configuration management is automated using industry-recognized tools like
   Terraform to enforce secure configuration standards.
...
6. Tidepool uses only approved and hardened containers in support of Tidepool Production
...
7. All IT assets in Tidepool have time synchronized to a single
    ...
    * All systems are configured to point to a common NTP server.
