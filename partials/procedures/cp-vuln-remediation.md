...
We follow a simple vulnerability tracking process using https:&#x2F;&#x2F;support.tidepool.org. The
...
- Upon identification of a vulnerability (including vulnerability in software,
  system, or process), a https:&#x2F;&#x2F;support.tidepool.org Issue of (issueType =
  **Finding**) is created on the SECURITY Project.

- Populate the following custom fields as part of the https:&#x2F;&#x2F;support.tidepool.org issue when
  applicable:
...
- An Exception must be opened in the form of a https:&#x2F;&#x2F;support.tidepool.org issue
  (issueType = **Exception**) on the SECURITY project.

- The Exception https:&#x2F;&#x2F;support.tidepool.org issue must reference the original Finding
  by adding an Issue Link to the Finding https:&#x2F;&#x2F;support.tidepool.org issue.
